...
urlpatterns = [
    ...
    #url(r'^meeting_list/(?P<pk>\d+)/$',views.MeetingListView.as_view(),name='meeting_list'),
    url(r'^add_meeting/(?P<pk>\d+)/$',views.MeetingCreateView.as_view(),name='add_meeting'),
    #url(r'^update_meeting/(?P<pk>\d+)/$',views.MeetingUpdateView.as_view(),name='update_meeting'),
    #url(r'^delete_meeting/(?P<pk>\d+)/$',views.MeetingDeleteView.as_view(),name='delete_meeting'),

    #url(r'^simple_appt/$',views.SimpleAppointmentCreateView.as_view(),name='simple_appt'),
    #url(r'^update_simple_appt/(?P<pk>\d+)$',views.SimpleAppointmentUpdateView.as_view(),name='update_simple_appt'),
    #url(r'^delete_appt/(?P<pk>\d+)$',views.AppointmentDeleteView.as_view(),name='delete_appt'),
